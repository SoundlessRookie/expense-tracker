...
export function AuthPage({ onAuthSuccess }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 p-4">
      {/* Background blobs */}
      ...
      >
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800">
          ...
          {/* Top banner */}
          <div className="relative p-8 pb-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-zinc-800 dark:to-zinc-900 border-b border-zinc-100 dark:border-zinc-800">
            <div className="flex flex-col items-center gap-3">
              ...
              >
                <BlobMascot size={80} isSad={false} animate={false} />
              </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <AnimatePresence>
                  {error && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -8 }}
                      className="p-3 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 rounded-xl"
                    >
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  whileTap={{ scale: 0.97 }}
                  className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-70 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 mt-2"
                >
                  {isLoading ? (
                    <>
                      <motion.div
